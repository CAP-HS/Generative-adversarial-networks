...
def myModel():
    ...
    model.add((Conv2D(no_Of_Filters, size_of_Filter, activation='relu')))#1st convolution layer
...
########## prediction of class '0' , speed limit 20kmh
...
import os
import glob
img_dir = "test_image_16_16"  # Enter Directory of all images
